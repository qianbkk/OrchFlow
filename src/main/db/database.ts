...
export function getDb(): DatabaseSync {
  ...
  // All operations below are synchronous (DatabaseSync, db.exec, runMigrations),
  // so no re-entrancy guard is needed — Node.js single-threaded event loop
  // guarantees atomicity until the first async boundary.
